...
export const get_hlt_mat = function (type) {
    const hlt_col = (type === "branch") ?
        ["#6dc5ff", "#ff6d6d", "#6ee8e2", "#fff0a6", "#ff9f6f", "#fa94d8"][Settings.click_type] :
        ["#47b6ff", "#ff4444", "#6ee8e2", "#ffe354", "#f9844a", "#ff47c2"][Settings.click_type];
    ...
    if ((type === "face" && [0].includes(Settings.click_type)) ||
        (type === "shape" && [1, 3, 4, 5].includes(Settings.click_type)) ||
